<template>
  ...
  <div>
    ...
    <!-- 放置一个日历组件 -->
    <el-calendar v-model="crrentDate">
...
export default {
  ...
  methods: {
    dataChange() {
      // 生成新的日期
      this.crrentDate = new Date(`${this.currentYear}-${this.currentMonth}-1`) // 以一号开始
    },
    // 判断是否时周末
    isWeek(date) {
